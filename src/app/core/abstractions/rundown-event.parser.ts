...
export abstract class RundownEventParser {
  ...
  public abstract parseAutoNextStartedEvent(event: unknown): AutoNextStartedEvent
  ...
  public abstract parsePieceReplacedEvent(event: unknown): RundownPieceReplacedEvent
