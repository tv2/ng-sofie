...
export class HttpActionTriggerService extends ActionTriggerService {
  ...
  constructor(private readonly http: HttpClient, private readonly httpErrorService: HttpErrorService) {
    super()
  }

  public getActionTriggers(): Observable<ActionTrigger[]> {
    return this.http.get<ActionTrigger[]>(ACTION_TRIGGER_URL)
      .pipe(catchError(error => this.httpErrorService.catchError(error)))
  }
}
