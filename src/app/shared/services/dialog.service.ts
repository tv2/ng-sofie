...
import { ConfirmationDialogComponent, DialogColorTheme, DialogSeverity } from '../components/confirmation-dialog/confirmation-dialog.component'
...
export class DialogService {
  ...
  public createConfirmDialog(title: string, message: string, okButtonText: string, onOk: () => void, theme?: DialogColorTheme, severity?: DialogSeverity): void {
