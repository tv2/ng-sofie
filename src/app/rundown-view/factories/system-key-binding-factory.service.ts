...
export class SystemKeyBindingFactory {
  ...
  public createActiveRundownKeyBindings(rundown: Rundown): StyledKeyBinding[] {
    return [
      ...
      this.createRundownKeyBinding('Set Segment Above as Next', ['Alt', 'ArrowUp'], () => this.setSegmentAboveNextAsNext(rundown)),
      this.createRundownKeyBinding('Set Segment Below as Next', ['Alt', 'ArrowDown'], () => this.setSegmentBelowNextAsNext(rundown)),
